-- TEST DATA ONLY. Apply scripts/ordering-v1-schema.sql and
-- scripts/modifier-option-defaults.sql first.
-- This seed enables ordering for exactly two known Armando source items and
-- attaches the same reusable modifier groups to both. Replace this test data
-- with restaurant-verified modifier definitions before production ordering.
